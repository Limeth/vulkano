...
impl BufferUsage {
	...
	pub fn vertex_buffer_transfer_destination() -> BufferUsage {
		BufferUsage { vertex_buffer: true, transfer_destination: true, ..BufferUsage::none() }
	}
	...
	pub fn index_buffer_transfer_destination() -> BufferUsage {
		BufferUsage { index_buffer: true, transfer_destination: true, ..BufferUsage::none() }
	}
	...
	pub fn indirect_buffer() -> BufferUsage {
		BufferUsage { indirect_buffer: true, ..BufferUsage::none() }
	}
	...
	pub fn indirect_buffer_transfer_destination() -> BufferUsage {
		BufferUsage { indirect_buffer: true, transfer_destination: true, ..BufferUsage::none() }
	}
}

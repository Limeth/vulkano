...
impl DirectionalLightingSystem {
		...
		R: RenderPassAbstract + Send + Sync + 'static
	{
		...
		DirectionalLightingSystem { gfx_queue, vertex_buffer, pipeline }
	}
	...
	pub fn draw<C, N>(
		&self, viewport_dimensions: [u32; 2], color_input: C, normals_input: N,
		direction: Vector3<f32>, color: [f32; 3]
	) -> AutoCommandBuffer
	where

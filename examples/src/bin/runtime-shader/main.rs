...
use vulkano::{
	...
	pipeline::{
		shader::{GraphicsShaderType, ShaderInterfaceDef, ShaderInterfaceDefEntry, ShaderModule},
...
fn main() {
	...
	unsafe impl ShaderInterfaceDef for VertInput {
		...
		fn elements(&self) -> VertInputIter { VertInputIter(0) }
	}
	...
	unsafe impl ShaderInterfaceDef for VertOutput {
		...
		fn elements(&self) -> VertOutputIter { VertOutputIter(0) }
	}
	...
	unsafe impl ShaderInterfaceDef for FragInput {
		...
		fn elements(&self) -> FragInputIter { FragInputIter(0) }
	}
	#[derive(Debug, Copy, Clone)]
	...
	unsafe impl ShaderInterfaceDef for FragOutput {
		...
		fn elements(&self) -> FragOutputIter { FragOutputIter(0) }
	}

...
fn main() {
	...
	let instance = {
		...
		//
		// While enabling validation layers is mostly recommended through the VK_INSTANCE_LAYERS
		// environment variable, it's a good thing to always enable them in examples to
		// catch any errors.
...
fn window_size_dependent_setup(
	images: &[Arc<SwapchainImage>], render_pass: Arc<RenderPassAbstract + Send + Sync>,
